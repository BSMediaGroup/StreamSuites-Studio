  ...
  return (
    <StudioShell roomWorkspace chatUnreadCount={chatUnread} chatOpen={preferences.sidebar === "expanded" || chatPeek} onOpenChat={openChat}>
      <section className="guest-room page-width">
        ...
        <p className="fine-print">Cloudflare RealtimeKit transports private room media using a Runtime/Auth-issued participant credential. The room remains OFF AIR.</p>
      </section>
